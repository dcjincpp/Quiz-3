...
static int compareEmployeeNumber(const void *targetPtr, PtrToConstEmployee tableValuePtr) //static function means only usable in this file and not any other file
...
//These are called wrappers. These functions are what you will use in your main!!! //calls a function that you dont want to change cause others use
